...
public class Shape {
    ...
    public void draw(Graphics window) {
        ...
        window.drawRect(xPos, getyPos(), getWidth(), getHeight());
        window.fillOval(xPos, getyPos(), getWidth(), getHeight());
        window.drawLine(xPos, getyPos() + getHeight(), xPos + getWidth(), getyPos());
        window.drawLine(xPos, getyPos(), xPos + getWidth(), getyPos() + getHeight());
